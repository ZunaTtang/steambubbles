...
- 상단 바: 기간 탭 / **범위 셀렉터**(Top 100 · 101~300 · 301~500 · 501~750 · 751~1,000 — 구간당 ≤250노드, 한 화면 최대 ~300 노드 캡 준수. 기존 301~1,000 단일 700노드 뷰는 2026-07 3분할. Tier 3 오픈 시 구간 추가, 칩이 과밀해지면 드롭다운 전환 검토) / **장르 필터 칩(다중 선택)** / 검색(게임명 자동완성) / 설정 / 즐겨찾기(★).
